...
export const getLabelBreadcrum = (key: string, route: 'admin' | 'admin-clinic' | ''): string => {
  if (route === 'admin') {
    switch (key) {
      ...
      case ADMIN_ROUTE_PATH.HISTORY_CONSULTING:
        return 'menu.doctorSupportHistory';
      case ADMIN_ROUTE_PATH.MEDICAL_SPECIALTY_MANAGEMENT:
      ...
      case ADMIN_ROUTE_PATH.CREATE_NEW:
        return 'menu.createNew';
      case ADMIN_ROUTE_PATH.DETAIL_NEW:
        return 'menu.detailNew';
      case ADMIN_ROUTE_PATH.STATISTIC:
      ...
      case ADMIN_ROUTE_PATH.REPORT_MANAGEMENT:
        return 'menu.report';
      case ADMIN_ROUTE_PATH.DETAIL_REPORT:
        return 'menu.detailReport';
      default:
        return '';
    }
