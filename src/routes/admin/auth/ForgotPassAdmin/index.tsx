...
import { FindUserByIdentifierDto } from '../../../../apis/client-axios';
...
const ForgotPassAdmin = () => {
  ...
  const checkIdentifierMutation = useMutation(
    (findUserByIdentifierType: FindUserByIdentifierDto) =>
      authApi.authControllerFindUserByIdentifierAndType(findUserByIdentifierType),
    {
      onSuccess: ({ data }, findUserByIdentifierType) => {
