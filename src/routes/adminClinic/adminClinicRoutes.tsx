  ...
  <Routes>
    ...
    <Route path="" element={<AdminClinic />}>
      <Route path={ADMIN_CLINIC_ROUTE_NAME.BOOKING_MANAGEMENT}>
        ...
        <Route path="" element={<SuspenseWrapper component={<ListBooking />} />} />
        <Route
          path={ADMIN_CLINIC_ROUTE_NAME.BOOKING_EMPTY}
          element={<SuspenseWrapper component={<ListBookingEmpty />} />}
        />
      </Route>
      <Route
        path={ADMIN_CLINIC_ROUTE_NAME.MEDICINE_MANAGEMENT}
        element={<SuspenseWrapper component={<ListMedicine />} />}
      />
