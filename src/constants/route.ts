...
export const ADMIN_ROUTE_PATH = {
  ...
  HISTORY_CONSULTING: `${ADMIN}/${ADMIN_ROUTE_NAME.DOCTOR_MANAGEMENT}/${ACTION.HISTORY_CONSULTING}`,
  ...
  DETAIL_REPORT: `${ADMIN}/${ADMIN_ROUTE_NAME.REPORT_MANAGEMENT}/${ACTION.DETAIL}`,
};
...
export const DOCTOR_CLINIC_ROUTE_NAME = {
  ...
  CHANGE_PASSWORD: 'change-password',
  PRESCRIPTION_TEAMPLATE: 'prescription-teamplate',
...
export const DOCTOR_CLINIC_ROUTE_PATH = {
  ...
  LIST_BOOKING: `${DOCTOR_CLINIC}/${DOCTOR_CLINIC_ROUTE_NAME.BOOKING_MANAGEMENT}/${ACTION.LIST}`,
  ...
  PRESCRIPTION_TEAMPLATE: `${DOCTOR_CLINIC}/${DOCTOR_CLINIC_ROUTE_NAME.PRESCRIPTION_TEAMPLATE}`,
  CREATE_PRESCRIPTION_TEAMPLATE: `${DOCTOR_CLINIC}/${DOCTOR_CLINIC_ROUTE_NAME.PRESCRIPTION_TEAMPLATE}/${ACTION.CREATE}`,
  DETAIL_PRESCRIPTION_TEAMPLATE: `${DOCTOR_CLINIC}/${DOCTOR_CLINIC_ROUTE_NAME.PRESCRIPTION_TEAMPLATE}/${ACTION.DETAIL}`,
};
